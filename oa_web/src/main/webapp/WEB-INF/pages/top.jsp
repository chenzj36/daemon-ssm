...
<head>
    ...
    <title> Daemon后台--欢迎使用Daemon后台管理系统 </title>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown menu-merge">
                <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
                    ...
                    <span class="hidden-xs pl15"> 个人账户 </span>
                ...
                <div class="sidebar-widget author-widget">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="media-author">状态：已登录</div>
...
<%--                        <li class="active">--%>
                ...
                <li>
                    <a class="accordion-toggle" href="#">
                        <span class="glyphicon glyphicon-check"></span>
                        <span class="sidebar-title">管理员</span>
                        <span class="caret"></span>
                    </a>
                    <ul class="nav sub-nav">
                        <li>
                            <a href="/administer/list">
                                <span class="glyphicon glyphicon-calendar"></span> 所有管理员 </a>
                        </li>
                        <li>
                        <a href="/administer/to_add">
                ...
                <li>
                    <a class="accordion-toggle" href="#">
                        <span class="glyphicon glyphicon-check"></span>
                        <span class="sidebar-title">baby</span>
                        <span class="caret"></span>
                    </a>
                    <ul class="nav sub-nav">
                        <li>
                            <a href="/baby/list">
                                <span class="glyphicon glyphicon-calendar"></span> 所有baby </a>
                        </li>
                        <li>
                            <a href="/baby/to_add">
                                <span class="glyphicon glyphicon-check"></span> 添加baby </a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a class="accordion-toggle" href="#">
                        <span class="glyphicon glyphicon-check"></span>
                        <span class="sidebar-title">babyFire</span>
                        <span class="caret"></span>
                    </a>
                    <ul class="nav sub-nav">
                        <li>
                            <a href="/babyFire/list">
                                <span class="glyphicon glyphicon-calendar"></span> 所有babyFire </a>
                        </li>
                        <li>
                            <a href="/babyFire/to_add">
                                <span class="glyphicon glyphicon-check"></span> 添加babyFire </a>
                        </li>
                    </ul>
                </li>
                <li>
